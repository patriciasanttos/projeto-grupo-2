...
const FormCard = ({ dispatch, state }: FormCardProps) => {
  ...
  const { mutate, isPending } = useCheckFirstSubmitByCNPJ();
  ...
  return (
    <>
      <Box className={Style.formCard}>
        ...
        <Typography>
          Preencha nosso formulário e receba instantaneamente as melhores
          soluções em equipamentos para o seu CME.
        </Typography>
